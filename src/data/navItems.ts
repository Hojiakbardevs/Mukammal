...
export const pageMetaByKey: Record<string, { crumb: string; title: string }> = {
  ...
  "t-course-detail": { crumb: "Trener / Kurs · SI asoslari", title: "Sun'iy intellekt asoslari · Modul boshqaruvi" },
  ...
  "a-analytics": { crumb: "Super Admin / Tahlil", title: "Tahlil markazi" },
  ...
  "a-ai-gov": { crumb: "Super Admin / Politika", title: "SI boshqaruvi va moderatsiya sozlamalari" },
...
export const teacherNav: LmsNavEntry[] = [
  ...
  { icon: "sparkles", label: "SI baholash nazorati", href: "/teacher/ai-grading", pageKey: "t-ai-grading", badge: { kind: "mute", text: "SI" } },
...
export const adminNav: LmsNavEntry[] = [
  ...
  { icon: "presentation", label: "Kurslar va o'quv oqimlari", href: "/admin/courses", pageKey: "a-courses" },
